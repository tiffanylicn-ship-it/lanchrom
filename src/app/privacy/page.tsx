    ...
    <div className="bg-white">
      <section className="py-16 md:py-20 border-b border-[#E6E3DD] bg-[#F7FAFC]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#8A8782] text-sm">Last updated: August 2026</p>
        </div>
      </section>
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-sm text-[#5C5A55]">
          ...
          <p>When you submit a form on our website (sample request, quote request, contact form, or OEM inquiry), we collect the information you provide — typically your name, company name, email address, phone number, and details about the products or services you&apos;re interested in. If you accept optional analytics, we also collect website usage information such as page views and referral source through Google Analytics.</p>
          ...
          <p>Google Analytics (GA4), Google Tag Manager, and HubSpot website tracking remain disabled until you select “Accept analytics” in our privacy preferences panel. If you select “Essential only,” these optional analytics services remain disabled and essential website functions continue to work. You can review or change your choice at any time using the “Cookie settings” button.</p>
          <p>We store your privacy preference locally so the website can remember your choice. Google reCAPTCHA may operate where needed to protect forms from abuse. Inquiry information that you choose to submit may be transferred to our customer relationship management system so we can respond to your request.</p>
