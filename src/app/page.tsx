...
const PRODUCT_CATEGORIES = [
  {
    name: "HPLC Solvents",
    href: "/products/high-purity-solvents/hplc-grade-solvents",
    img: "/images/cards/hplc-solvents-card.jpg",
    note: "Gradient, isocratic and UV-qualified grades",
    products: [
      { name: "Acetonitrile", href: "/products/hplc-grade-solvents/acetonitrile" },
      { name: "Methanol", href: "/products/hplc-grade-solvents/methanol" },
      { name: "Isopropanol (IPA)", href: "/products/hplc-grade-solvents/ipa" },
      { name: "n-Hexane", href: "/products/hplc-grade-solvents/n-hexane" },
      { name: "Ethyl Acetate", href: "/products/hplc-grade-solvents/ethyl-acetate" },
    ],
  },
  {
    name: "LC-MS Solvents",
    href: "/products/high-purity-solvents/lcms-grade-solvents",
    img: "/images/cards/lcms-solvents-card.jpg",
    note: "Low ion suppression and trace-metal control",
    products: [
      { name: "Acetonitrile — LC-MS Grade", href: "/products/hplc-grade-solvents/acetonitrile" },
      { name: "LC-MS Water (Ultrapure)", href: "/products/lcms-grade-solvents/lc-ms-grade-water-ultrapure" },
      { name: "Ammonium Acetate 10mM", href: "/products/lcms-mobile-phase-additives/lc-ms-grade-ammonium-acetate-10mm" },
      { name: "Ammonium Formate 10mM", href: "/products/lcms-mobile-phase-additives/lc-ms-grade-ammonium-formate-10mm" },
    ],
  },
  {
    name: "Spectroscopy",
    href: "/products/high-purity-solvents/spectroscopic-grade-solvents",
    img: "/images/cards/spectroscopy-solvents-card.jpg",
    note: "Low absorbance solvents for optical analysis",
    products: [
      { name: "Spectroscopic Grade Chloroform", href: "/products/hplc-grade-solvents/chloroform" },
      { name: "Spectroscopic Grade n-Hexane", href: "/products/hplc-grade-solvents/n-hexane" },
      { name: "Spectroscopic Grade DCM", href: "/products/hplc-grade-solvents/dichloromethane" },
    ],
  },
  {
    name: "Electronic Chemicals",
    href: "/products/high-purity-solvents/electronic-semiconductor-grade-chemicals",
    img: "/images/cards/electronic-chemicals-card.jpg",
    note: "Ultra-high purity for wafer and display processes",
    products: [
      { name: "Ethanol — Electronic Grade", href: "/products/hplc-grade-solvents/ethanol" },
      { name: "Isopropanol (IPA)", href: "/products/electronic-grade-ipa" },
      { name: "PGME", href: "/products/pharmaceutical-grade-solvents/pgme" },
      { name: "PGMEA", href: "/products/pharmaceutical-grade-solvents/pgmea" },
    ],
  },
];
