...
export default function ProductsIndexPage() {
  ...
  return (
    <div className="bg-white">
      {/* Hero with product solutions background — full-bleed image + diagonal wash, matching the homepage hero style */}
      <section className="relative overflow-hidden min-h-[460px] flex items-center bg-[#0A302E]">
        <Image src="/images/backgrounds/product-solutions.png" alt="LANCHROM product solutions" fill priority sizes="100vw" className="object-cover object-center" />
        <div className="home-hero-green-wash absolute inset-y-0 left-0 z-[1]" aria-hidden="true" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10 w-full">
          <p className="text-xs font-bold tracking-[0.1em] uppercase text-[#5FD4DC] mb-3 [text-shadow:0_1px_10px_rgba(4,47,45,0.4)]">Product Catalog</p>
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 [text-shadow:0_2px_12px_rgba(4,47,45,0.45)]">
            8 Product Lines - {totalCategories} Categories - {totalProducts}+ SKUs
          </h1>
          <p className="text-white/85 text-lg max-w-2xl leading-relaxed [text-shadow:0_1px_10px_rgba(4,47,45,0.4)]">
